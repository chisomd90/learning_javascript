...
if (num > 0) {
  console.log(`${num} is a positive rating`);
} else {
  console.log(`${num} is a negative rating`);
}

// write an if else statement to determine if a rating is odd or even
const num1 = 76;

if (num1 % 2 === 0) {
  console.log(`${num1} is an even rating`);
} else {
  console.log(`${num1} is an odd rating`);
}
...
if (burnley > sunderland) {
  console.log(`Burney has won by ${burnley} goals`);
} else if (burnley < sunderland) {
  console.log(`sunderland has won by ${sunderland} goals`);
} else {
...
if (totalGoals > 4 && burnley === sunderland) {
  console.log("WON");
} else {
...
// Samuels bet, liverpool wins and liverpool scores less than 4, and the total corners is 9

const liverpool = 6;
const mancity = 5;
const liverpoolcorners = 5;
const mancitycorners = 4;
